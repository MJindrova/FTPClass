...
/* Základní obrázky                                        */
paPopup=["../../imgs/popup.gif","../../imgs/popupl.gif"];   // Obrázek pøíznaku popupu
paMark=["../../imgs/mark.gif","../../vmarke.gif"];   // Obrázek pøíznaku oznaèení, ne-oznaèení
paHL=["../../imgs/hlon.gif","../../imgs/hloff.gif","../../imgs/hlds.gif"];  // Obrázek pøíznaku aktivace, ne-aktivace, zakázaný
